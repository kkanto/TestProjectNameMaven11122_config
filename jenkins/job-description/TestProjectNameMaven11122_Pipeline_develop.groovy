...
def job_config = [
    job: [
        name: "TestProjectNameMaven11122_Pipeline_develop"
    ],
    git: [ 
        branch: "develop"
    ]
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                echo "checkout"
                script {
                    jslGit.checkout( config, "JEQP", "TestProjectNameMaven11122_Pipeline_develop", "develop")
                }
            }    
        }
        stage('Build') {
